...
('platform_fee_percentage', '5', 'Platform fee percentage for transactions', 'financial', false),
('default_worker_verification_required', 'true', 'Require verification for worker registration', 'verification', true),
('max_campaign_duration_days', '90', 'Maximum campaign duration in days', 'campaigns', true),
('max_event_capacity', '1000', 'Maximum event capacity', 'events', true),
('content_moderation_enabled', 'true', 'Enable content moderation', 'moderation', false),
('auto_assign_issues_by_location', 'true', 'Auto-assign issues to officials based on location', 'automation', false);
...
COMMENT ON SCHEMA public IS 'JijiSauti Civic Intelligence Platform Database Schema - Production Ready v1.0.0';

-- Create a simple view for app status
CREATE VIEW app_status AS
SELECT 
    'JijiSauti Platform' as app_name,
    '1.0.0' as version,
