...
-- Insert sample collaboration groups
INSERT INTO collaboration_groups (title, description, issue_focus, created_by, address, tags) VALUES
('Kilimani Drainage Taskforce', 'Community group focused on fixing drainage issues in Kilimani area', 'Infrastructure', (SELECT id FROM user_profiles LIMIT 1), 'Wood Avenue, Kilimani', ARRAY['drainage', 'infrastructure', 'flooding']),
('Yaya Market Vendors Association', 'Supporting street vendors and informal workers around Yaya Center', 'SME Empowerment', (SELECT id FROM user_profiles LIMIT 1), 'Yaya Center, Kilimani', ARRAY['vendors', 'informal-economy', 'rights']),
('Kindaruma Tree Planting Crew', 'Environmental group organizing tree planting and green space initiatives', 'Environment', (SELECT id FROM user_profiles LIMIT 1), 'Kindaruma Road, Kilimani', ARRAY['environment', 'trees', 'green-space']);
