-- Create enhanced tables for JijiSauti platform - Fixed policies
...
ALTER TABLE civic_issues ADD COLUMN IF NOT EXISTS latitude DECIMAL;
ALTER TABLE civic_issues ADD COLUMN IF NOT EXISTS longitude DECIMAL;
...
ALTER TABLE job_postings ADD COLUMN IF NOT EXISTS latitude DECIMAL;
ALTER TABLE job_postings ADD COLUMN IF NOT EXISTS longitude DECIMAL;

ALTER TABLE collaboration_groups ADD COLUMN IF NOT EXISTS latitude DECIMAL;
ALTER TABLE collaboration_groups ADD COLUMN IF NOT EXISTS longitude DECIMAL;
...
CREATE POLICY "Authenticated users can report violations" ON zoning_violations FOR INSERT WITH CHECK (true);
